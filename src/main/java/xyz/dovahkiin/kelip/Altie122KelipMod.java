package xyz.dovahkiin.kelip;

import xyz.dovahkiin.kelip.init.Altie122KelipModTabs;
import xyz.dovahkiin.kelip.init.Altie122KelipModItems;
...
@Mod("altie122_kelip")
public class Altie122KelipMod {
	public static final Logger LOGGER = LogManager.getLogger(Altie122KelipMod.class);
	public static final String MODID = "altie122_kelip";

	public Altie122KelipMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		Altie122KelipModItems.register(modEventBus);

		Altie122KelipModTabs.REGISTRY.register(modEventBus);
